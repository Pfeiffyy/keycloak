 ...
 * 
 */
package com.pf.keycloak.KeycloakFieldValidation.form;
...
//		}
		...
		if (isBlank(formData.getFirst("user.attributes.betriebsart"))) {
			errors.add(new FormMessage("user.attributes.betriebsart", "missingBetriebsart"));
		}
